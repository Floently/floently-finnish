...
for(const f of ["index.html","read/index.html","create/index.html","vercel.json","sitemap.xml"]){
...
if(!home.includes("https://www.kielivalmis.com/")) throw new Error("Floently root lost KieliValmis gateway");
...
const expected=new Map([
 ["/learn","https://www.kielivalmis.com/"],
 ["/privacy","https://www.kielivalmis.com/privacy"],
 ["/privacy-policy","https://www.kielivalmis.com/privacy"],
 ["/learn/privacy","https://www.kielivalmis.com/privacy"],
 ["/learn/privacy-policy","https://www.kielivalmis.com/privacy"],
 ["/legal/privacy-policy","https://www.kielivalmis.com/privacy"],
 ["/terms","https://www.kielivalmis.com/terms"],
 ["/learn/terms","https://www.kielivalmis.com/terms"],
 ["/support","https://www.kielivalmis.com/support"],
 ["/learn/support","https://www.kielivalmis.com/support"],
 ["/delete-account","https://www.kielivalmis.com/delete-account"],
 ["/account-deletion","https://www.kielivalmis.com/delete-account"],
 ["/learn/delete-account","https://www.kielivalmis.com/delete-account"],
 ["/learn/account-deletion","https://www.kielivalmis.com/delete-account"],
 ["/legal/account-deletion","https://www.kielivalmis.com/delete-account"]
]);
