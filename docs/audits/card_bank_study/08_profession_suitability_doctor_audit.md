...
Evidence:
- Doctor runtime count: 13689.
- Coverage evidence is in [profession_coverage_doctor.csv](/home/vitus/floently-finnish/docs/audits/card_bank_study/profession_coverage_doctor.csv).
- Strong examples exist in external curated doctor phrase and grammar packs.
- Weak examples in the live bank include historical and article-derived sentences from professional phrase files.

PASS / WARN / FAIL:
- role-specific lexical density: WARN
- patient communication: WARN
- medication/symptom language: WARN
- consent/privacy: FAIL
- handover/documentation: FAIL
- empathy/family communication: FAIL
...
- `/home/vitus/Asiakirjat/project_documents/floently-finnish/complied_card_materials/fraasit/lääkäri_fraasit/lääkäri_fraasit.json`
- `/home/vitus/Asiakirjat/project_documents/floently-finnish/complied_card_materials/kielioppi/lääkäri_kielioppi/lääkäri_kielioppi.json`

Remediation:
- Build doctor packs for consent, explaining results, treatment planning, documentation, escalation, and relative communication.

Verification steps:
- rerun doctor coverage CSV and manually sample 50 cards from the missing domains.
